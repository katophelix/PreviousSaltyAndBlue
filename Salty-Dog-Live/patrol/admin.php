...
Copyright 2019 saltydog.com
License: http://www.saltydog.com/license.php

FormID:  jqueryform-f321f3
Date:    2019-04-23 18:18:17
Version: v3.0.2
Generated by http://www.saltydog.com
...
class Admin {
    ...
    private static function exitIfCsrfTokenNotValid(){
        ...
        if( $_POST['csrf_token'] !== $sessionToken ){
            echo ' Form error: csrf_token is not valid!';
            exit;
        };
    }
    ...
    private static function checkReferer(){
        ...
        if( self::isMySite() && false === stripos( $host, 'saltydog.com') ){
            die(' Form error: can not directly access form admin panel on saltydog.com');
        };
    }
...
?>
    ...
    <li>
        <h3>Your Form</h3>
<?php
$editFormUrl = 'https://www.saltydog.com/builder.php';
...
?>
        ...
        <a href="http://www.saltydog.com/help">help</a>
    </li>
